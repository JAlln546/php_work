...
$query->bind_param("sssssssibbsssssss", $color, $cellar, $name, $category, $type, $vintage, $region, $price, $fbImg, $labelImg, $description, $temp, $pairing, $notes, $varietals, $link, $class);
